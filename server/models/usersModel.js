...
const usersSchema = mongoose.Schema(
  {
    username: { type: String, require: true, validate: {
      validator: function (v) { // the value is always taken from the field (username in this case) - after that you can use regex etc 
